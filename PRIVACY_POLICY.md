...
- **API key**: If you choose to enter a metalpriceapi.com API key for live prices, it is stored in encrypted device storage (expo-secure-store)
...
Stackers can optionally fetch live precious metals prices from **metalpriceapi.com** if you provide an API key. When enabled:

- A network request is made to metalpriceapi.com with your API key to fetch current prices
